...
;
;
;  Syntax :=  ERASE FILENAME/EXT:lw#<ENTER>
;
;
...
ende	DEFM      0DH     ;in den zurückliegenden 11 bytes
			...
			;zu werden
schlech	DEFM	'Syntax := ERASE FILENAME/EXT'
	DEFM	':<lw#>ENTER'
...
copy	LD	A,'E'		; Endemarkierung
	...
	LD	A,(431eh)	; erstes Zeichen nach
				; 'ERASE '
	CP	'*'		; falls '*/* folgt
	JR	NZ,goon
	LD	A,(431fh)
...
keinfe	JP	doserr
meld1	DEFM	'Wirklich alle Files löschen ?',0dh
meld2	DEFM	'Dann jetzt <J> drücken ',03h
